...
//	private JSONObject messageJson;
	...
	public Request(String url, String method, String msg){
		...
		String tmp = this.uri;
		LoggingManager.getInstance().log(this, tmp);
	...
	public Socket getSocket() throws NumberFormatException, UnknownHostException, IOException{
		if(this.protocolType.equals("HTTP")){
			System.setProperty("javax.net.ssl.trustStore", "clienttrust");
			SSLSocketFactory ssf = (SSLSocketFactory) SSLSocketFactory.getDefault();
			return ssf.createSocket(this.host, Integer.parseInt(this.port));
		}else if(this.protocolType.equals("HTTPS")){
